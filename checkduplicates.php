...
$regEmailMode = $table == "users" && $fieldName == $cEmailField;
$regUsernameMode = $table == "users" && $fieldName == $cUserNameField;
$denyChecking = $denyChecking && ( $table != "users" || $fieldName != $cUserNameField && $fieldName != $cEmailField );
