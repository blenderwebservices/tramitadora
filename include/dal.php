...
class tDAL
{
	var $tbltramitadora_at_localhost__registro;
	var $tbltramitadora_at_localhost__tiposdoc;
	var $tbltramitadora_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "registro", "varname" => "tramitadora_at_localhost__registro", "altvarname" => "registro", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
		$this->lstTables[] = array("name" => "tiposdoc", "varname" => "tramitadora_at_localhost__tiposdoc", "altvarname" => "tiposdoc", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "tramitadora_at_localhost__users", "altvarname" => "users", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
	}
