...
class ConnectionManager
{
	...
	{
		return $this->byId( "tramitadora_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "tramitadora_at_localhost";
		$data["connName"] = "tramitadora at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;tramitadora;N@@4vf51v;;tramitadora;;1"; //currently unused

		$this->_connectionsIdByName["tramitadora at localhost"] = "tramitadora_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "tramitadora";
		$data["ODBCPWD"] = "N@@4vf51v";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "tramitadora";
		$data["connInfo"][2] = "N@@4vf51v";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "tramitadora";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=tramitadora;OPTION=3";
		// encription set
		$data["EncryptInfo"] = array();
		$data["EncryptInfo"]["mode"] = 2;
		$data["EncryptInfo"]["alg"]  = 128;
		$data["EncryptInfo"]["key"]  = "5ba4ec7cf96649b784b8b701e2ccd660";

		$connectionsData["tramitadora_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["registro"] = "tramitadora_at_localhost";
		$connectionsIds["users"] = "tramitadora_at_localhost";
