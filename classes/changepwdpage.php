...
class ChangePasswordPage extends RunnerPage
{
	...
	protected function getUpdateSQL( $newpass, $where )
	{
		...
		if( $this->token )
		{
			...
			$setPart.= ", ". $this->connection->addFieldWrappers( "active" )."=1 ";
		}
	...
	protected function checkToken()
	{
		...
		$sqlSelect = "select ".$this->connection->addFieldWrappers( "reset_date" )." from".$this->connection->addTableWrappers("users")
