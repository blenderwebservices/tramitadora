...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "registro" ] = array( "url" => "registro", "type" => 0 );
	$projectEntitiesReverse[ "registro" ] = "registro";
	$projectEntities[ "users" ] = array( "url" => "users", "type" => 0 );
	$projectEntitiesReverse[ "users" ] = "users";
	$projectEntities[ "tiposdoc" ] = array( "url" => "tiposdoc", "type" => 0 );
	$projectEntitiesReverse[ "tiposdoc" ] = "tiposdoc";
}
