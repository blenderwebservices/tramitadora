...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "tramitadora_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "registro", "varname" => "tramitadora_at_localhost__registro", "altvarname" => "registro", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
			$dalTables[$conn->connId][] = array("name" => "tiposdoc", "varname" => "tramitadora_at_localhost__tiposdoc", "altvarname" => "tiposdoc", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "tramitadora_at_localhost__users", "altvarname" => "users", "connId" => "tramitadora_at_localhost", "schema" => "", "connName" => "tramitadora at localhost");
		}
	}
